...
public class Faculty extends Fragment {
    ...
    final String[] facultyNames = {"Eng. Md. Razu Ahmed", "Dr. Mohammed Saifuddin", "Amanul Hoque", "Md Jiabul Hoque", "Areez Hafiz Md Zahid", "Mohammad Nadib Hasan", "Md. Humayun Kabir", "Hassan Jaki", "Zarin Tanzim"};
    final String[] facultyDesignations = {"Professor & Chairman", "Assistant Professor", "Assistant Professor", "Lecturer", "Lecturer", "Lecturer", "Lecturer", "Lecturer", "Lecturer"};
    final String[] facultyContactNumbers = {"01874543665", "01945767849", "01818673657", "01989685996", "01977723403", "01521483958", "01515286984", "01950853985", "01850925671"};
    final int[] facultyImages = {R.drawable.razus, R.drawable.saifs, R.drawable.amans, R.drawable.jias, R.drawable.teacher_df, R.drawable.nadibs, R.drawable.rabbys, R.drawable.zakis, R.drawable.teacher_df};
